...
SKIP_LIST = {
    ...
    "sagemaker_processing/spark_distributed_data_processing/sagemaker-spark-processing.ipynb",
    "step-functions-data-science-sdk",
    "training/distributed_training/pytorch/data_parallel/mnist/infer_pytorch.ipynb",
